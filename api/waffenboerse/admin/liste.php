...
// Security-Finalisierung ("Informationslecks"): siehe identischer Kommentar
// in api/hundeboerse/admin/liste.php.
try {
    $rows = $pdo->query(
    ...
    error_log('KJS Waffenboerse Admin: Laden der Liste fehlgeschlagen - ' . $e->getMessage());
